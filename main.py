...
class FirstScr(Screen):
    ...
    #     print(str(inpt.text))
    #     try:
    #         if str(inpt.text[-1]) == 'ь':
    #             lbl2 = Label(text=get_weather('Погода_в_'+str(inpt.text[:-1])+'и'), size_hint=(0.2, 0.1), pos_hint={'center_x': 0.5, 'center_y': 0.3}, color=(0,0,0,1))
    ...
    #             print(lbl2)
    #     except:
    #         print('asdfsdgfdfgdsfgggggggggggggggggggggggjh')
    def vbg(self):
...
class SecondScr(Screen):
    def __init__(self, name='second'):
        ...
        if 'дождь' in lbl2.text:
            img3 = Image(source='pngtree-cartoon-style-rain-cloud-png-image_2486263-Photoroom.png', size_hint=(0.65, 0.65), pos_hint={'center_x': 0.5, 'center_y': 0.7})
            self.add_widget(img3)
        elif 'облачно' in lbl2.text:
            img = Image(source='png-transparent-dark-cloud-thumbnail-Photoroom.png', size_hint=(0.65, 0.65), pos_hint={'center_x': 0.5, 'center_y': 0.7})
            self.add_widget(img)
        else:
            img2 = Image(source='pngtree-sun-cartoon-cute-doodle-summer-png-image_6646856.png', size_hint=(0.4, 0.4), pos_hint={'center_x': 0.5, 'center_y': 0.8})
